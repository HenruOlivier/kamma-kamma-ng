...
export class ProductFormComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.formDefinition = [
      ...
      { type: FormFieldTypes.Select, name: 'group', label: 'Group', required: false, dataset: this.scaleGroupService.getAllScaleGroups(), headerField: 'groupName', searchEnabled: true },
  ...
  ngOnInit() {
    ...
    if (this._id) {
      this.productsService.getOneScale(this._id)
        .subscribe(
          (response) => {
            if (response) {
  ...
  // onResetConfig() {
  //   this.calibrationData = [...DEFAULT_SCALE_CALIBRATION];
  //   console.log('calibration default: ', DEFAULT_SCALE_CALIBRATION);
